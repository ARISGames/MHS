var IronMineModel = function()
{
    ...
    var STATION_IDS = [];
    STATION_IDS[STATION_TYPE_DRILL]    = [3545,1151,1152,1153,1154]; //All webpage/station Id's of type 'drill'
    STATION_IDS[STATION_TYPE_DYNAMITE] = [3548,1155,1156]; //All webpage/station Id's of type 'dynamite'
    STATION_IDS[STATION_TYPE_BACKER]   = [3555,1160]; //All webpage/station Id's of type 'backer'
    STATION_IDS[STATION_TYPE_STRIKE]   = [3556,3031]; //All webpage/station Id's of type 'strike'
