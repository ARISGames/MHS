var DrillGame = function()
{
    ...
    function advanceDrill()
    {
        ...
        else
        {
            ...
            else { if(imm.money < moneyLost) imm.money = moneyLost; ARIS.setItemCount(imm.ITEM_IDS[0], imm.money-moneyLost); imv.displayFail("You've lost "+moneyLost+" cents!"); } //<- trust this
            lastReceivedLight = 0;
            recedeDrill();
        }
    }
