...
PLAYGROUND.Transitions.implode = function(progress, layer, screenshot) {
  ...
  progress = PLAYGROUND.Utils.ease(progress, "outCubic");

  var negative = 1 - progress;

  layer.save();
  layer.tars(layer.center.x, layer.center.y, 0.5, 0.5, 0, 0.5 + 0.5 * negative, negative);
...
PLAYGROUND.Transitions.split = function(progress, layer, screenshot) {
  ...
  progress = PLAYGROUND.Utils.ease(progress, "inOutCubic");
  ...
  layer.drawImage(screenshot, 0, 0, layer.width, layer.height / 2 | 0, 0, 0, layer.width, negative * layer.height / 2 | 0);
  layer.drawImage(screenshot, 0, layer.height / 2 | 0, layer.width, layer.height / 2 | 0, 0, layer.height / 2 + progress * layer.height / 2 + 1 | 0, layer.width, Math.max(1, negative * layer.height * 0.5 | 0));
